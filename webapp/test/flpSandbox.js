		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HR App",
									"targetURL": "#edubeaphrzsd002hr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"edubeaphrzsd002hr-display": {
								"semanticObject": "edubeaphrzsd002hr",
								"action": "display",
								"description": "A Fiori application to check hr data",
								"title": "HR App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=edu.be.ap.hr.zsd002hr",
									"url": sap.ui.require.toUrl("edu/be/ap/hr/zsd002hr")
								}
							}
						}
					}
